...
@Component({
  selector: 'app-ausentismos-procesados-persona',
  templateUrl: './ausentismos-procesados-persona.component.html',
  styleUrls: ['./ausentismos-procesados-persona.component.scss']
})
export class AusentismosProcesadosPersonaComponent implements OnInit {
  ...
  obtenerSolicitudes() {
    this.ausentismosService.getSolicitudesPorAutorizador(this.usuarioService.usuario, this.usuarioService.empresa, this.usuarioService.cadenaConexion)
      .subscribe(
        (data: any) => {
