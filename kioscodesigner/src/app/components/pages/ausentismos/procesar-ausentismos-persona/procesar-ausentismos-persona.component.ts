...
@Component({
  selector: 'app-procesar-ausentismos-persona',
  templateUrl: './procesar-ausentismos-persona.component.html',
  styleUrls: ['./procesar-ausentismos-persona.component.scss']
})
export class ProcesarAusentismosPersonaComponent implements OnInit {
  ...
  cargarDatosSolicitudesProcesadas() {
    if (this.ausentismoService.SolicitudesJefe == null) {
      this.ausentismoService.getSoliciAusentSinProcesarAutorizador(this.usuarioService.empresa, this.usuarioService.usuario, 'ENVIADO', this.usuarioService.cadenaConexion)
        .subscribe(
          (data: any) => {
